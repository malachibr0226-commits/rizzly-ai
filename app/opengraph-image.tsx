      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 900 }}>
          <div style={{ fontSize: 70, fontWeight: 800, lineHeight: 1.05 }}>
            Smarter replies for real conversations.
          </div>
          <div style={{ fontSize: 28, color: "rgba(255,255,255,0.82)", lineHeight: 1.4 }}>
            Paste a chat, import a screenshot, or transcribe a voice note and get sharper next messages in seconds.
          </div>
        </div>
